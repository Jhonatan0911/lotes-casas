...
@Component({
  selector: 'app-modal-origen',
  templateUrl: './modal-origen.component.html',
  styleUrls: ['./modal-origen.component.css']
})
export class ModalOrigenComponent extends BaseFormComponent implements OnInit {

  constructor(
    private combosService: CombosService,
    private toastService: ToastService,
    private ErrorService: ErrorService,
    public dialogRef: MatDialogRef<ModalOrigenComponent>,
  ...
  submit() {
    if (this.form.valid) {
      ...
      this.combosService.createOrigenes(this.form.value).subscribe({
        next: (req) => {
          console.log(req)
          this.loading = false;
